...
export default function OurService() {
  ...
  const services = useMemo(
    () => [
      ...
      { key: 'hardware', icon: FaServer, color: '#FF9800', image: '/assets/hardware.webp' },
      { key: 'software', icon: FaCode, color: '#9C27B0', image: '/assets/software.webp' },
      { key: 'cybersecurity', icon: FaShieldAlt, color: '#F44336', image: '/assets/security.webp' }
    ],
    []
  )
