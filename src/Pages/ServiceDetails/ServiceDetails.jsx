    ...
    return (
      <div className="container py-5">
        <div className={styles.notFoundCard}>
          <h2 className="mb-2">{isRTL ? 'الخدمة غير موجودة' : 'Service not found'}</h2>
          <p className="mb-4">
            {isRTL
    ...
    <main className={styles.page} dir={isRTL ? 'rtl' : 'ltr'}>
      ...
      <section className="container py-5">
        <div className={styles.sectionHeader}>
          <h2 className={styles.sectionTitle}>{isRTL ? 'التقنيات اللي بنستخدمها' : 'Tech stack'}</h2>
      ...
      <section className={styles.altSection}>
        <div className="container py-5">
          <div className={styles.sectionHeader}>
            <h2 className={styles.sectionTitle}>{isRTL ? 'هنسلمك إيه؟' : 'What you get'}</h2>
            <p className={styles.sectionSubtitle}>
              {isRTL
        ...
        <div className={styles.cta}>
          <div>
            <h3 className={styles.ctaTitle}>
              {isRTL ? 'عايز نفس الخدمة بس بمواصفات خاصة؟' : 'Need this service tailored to you?'}
            </h3>
            <p className={styles.ctaText}>
              {isRTL
                ? 'ابعت تفاصيل مشروعك وهنرجعلك بخطة تنفيذ واضحة.'
